...
// Ask retrieves then synthesizes a cited answer. opts are forwarded to the
// internal Retrieve call (see WithHybrid).
func Ask(ctx context.Context, r Retriever, emb semcache.Embedder, llm LLMConfig, corpus, question string, k int, opts ...Option) (AskResult, error) {
	...
	hits, err := Retrieve(ctx, r, emb, corpus, question, k, opts...)
	if err != nil {
